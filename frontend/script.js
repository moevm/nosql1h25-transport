...
async function fetchCars() {
  ...
  const type_year_from = document.getElementById("filterTypeyearfrom")?.value;
  const type_year_to = document.getElementById("filterTypeyearto")?.value;
  ...
  if (type_year_from) params.append("type_year_from", type_year_from);
  if (type_year_to) params.append("type_year_to", type_year_to);
