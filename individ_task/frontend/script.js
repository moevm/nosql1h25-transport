...
async function fetchRents() {
  ...
  const date_of_begining_from = document.getElementById("filterTypedateofbeginingfrom")?.value;
  const date_of_begining_to = document.getElementById("filterTypedateofbeginingto")?.value;
  const date_of_ending_from = document.getElementById("filterTypedateofendingfrom")?.value;
  const date_of_ending_to = document.getElementById("filterTypedateofendingto")?.value;
  const params = new URLSearchParams();
  if (type_order_name) params.append("type_order_name", type_order_name);
  if (type_registration_number) params.append("type_registration_number", type_registration_number);
  if (type_rent_id) params.append("type_rent_id", type_rent_id);
  if (date_of_begining_from) params.append("date_of_begining_from", date_of_begining_from);
  if (date_of_begining_to) params.append("date_of_begining_to", date_of_begining_to);
  if (date_of_ending_from) params.append("date_of_ending_from", date_of_ending_from);
  if (date_of_ending_to) params.append("date_of_ending_to", date_of_ending_to);
